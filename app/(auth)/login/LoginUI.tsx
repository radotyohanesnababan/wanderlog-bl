// app/(auth)/login/LoginUI.tsx
'use client';

import LoginButton from "./LoginButton";
import dynamic from 'next/dynamic';

const AuthHandler = dynamic(() => import('./AuthHandler'), { ssr: false });
    ...
    >
      ...
      <div className="w-full max-w-sm text-center space-y-8">
        ...
        <p className="text-slate-600 text-xs">
          Data perjalananmu bersifat Privat. 
          Kami tidak akan membagikan data kamu ke pihak lain tanpa izinmu.
        </p>
      </div>
    </main>
  );
